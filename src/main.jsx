...
import Conv4 from './conversations/conv4.jsx'
import Conv5 from './conversations/conv5.jsx'
import Conv6 from './conversations/conv6.jsx'
...
import Conv10 from './conversations/conv10.jsx'
...
ReactDOM.createRoot(document.getElementById('root')).render(
  <HashRouter>
    <Routes>
      ...
      <Route path="/conv4" element={<Conv4 />} />
      <Route path="/conv5" element={<Conv5 />} />
      <Route path="/conv6" element={<Conv6 />} />
      <Route path="/conv7" element={<Conv7 />} />
      <Route path="/conv8" element={<Conv8 />} />
      <Route path="/conv9" element={<Conv9 />} />
      <Route path="/conv10" element={<Conv10 />} />
    </Routes>
  </HashRouter>
)
