...
const conversations = [
  ...
  { path: '/conv4', title: 'Conversation 4', subtitle: 'Upper Respiratory', available: true },
  { path: '/conv5', title: 'Conversation 5', subtitle: 'Pneumonia', available: true },
  { path: '/conv6', title: 'Conversation 6', subtitle: 'Asthma', available: true },
