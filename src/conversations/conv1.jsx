...
const CONVERSATION_PROMPT = [
  ...
  "'So, gas exchange needs a few things to work.' (new bubble — pivot) 'Can you think of what has to be true for O2 to get from the air into your blood?' (standalone question)",
  ...
  "'Think about the alveolar membrane itself. What could interfere with diffusion?' (standalone question)",
  ...
  "",
  "STEP 7 — SCENARIOS (2-3 progressive):",
  ...
  "Pattern: 'Ok, let us try a scenario. Read the whole thing first.' (bubble)",
  ...
  "Affirmation first (bubble). Then 'Ok, one more.' (bubble). Then scenario text (bubble). Then question (bubble).",
