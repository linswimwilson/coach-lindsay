...
const BASE_PROMPT = [
  ...
  "",
  "FAILURE 9 — Looping back to an already-answered question.",
  ...
  "WRONG: Student says 'gas exchange' → you confirm it → you ask 'where does air go?' → student says 'pharynx' → you say 'not quite, I am asking about PURPOSE' — NO. You already moved past purpose.",
  ...
  "Common examples: 'gas exchange' heard as 'cast exchange' or 'house exchange' or 'gas is change'. 'pharynx' heard as 'fair inks'. 'alveoli' heard as 'all veoli'.",
...
const CONVERSATION_PROMPT = [
  ...
  "PURPOSE OF THIS STEP: Walk the student through the full anatomical pathway air travels. This IS anatomy. That is the point.",
  ...
  "CRITICAL: If the student says 'pharynx' that is CORRECT. If they say 'larynx' that is CORRECT. Accept each anatomical structure and move to the next one.",
  "Do NOT loop back to 'what is the PURPOSE of the lungs' during this step. Purpose was Step 1. We are past that. This step is ANATOMY.",
  "If they skip steps (e.g., go straight from pharynx to trachea), say 'Close! There is one in between — the larynx.'",
