...
const CONVERSATION_PROMPT = [
  ...
  "  1. What asthma is: inflamed bronchi, narrowed lumen, air cannot get out",
  "  2. Extrinsic vs intrinsic pathways",
  "  3. Acute asthma: reversible airway constriction",
  "  4. Asthma variants: nocturnal, exercise-induced, occupational, drug-induced",
  "  5. Stages of an asthma attack",
  "  6. Status asthmaticus: when it becomes life-threatening",
  "  7. Treatment: bronchodilators, steroids, epinephrine",
