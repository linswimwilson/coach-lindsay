...
const CONVERSATION_PROMPT = [
  ...
  "",
  "CRITICAL TEACHING POINT, reinforce this strongly:",
  "'Here is why your professor hammers this. Once alveoli collapse, they are very hard to reinflate.' (bubble)",
  "'Much harder than keeping them open in the first place.' (bubble)",
  "'So clinically, the whole goal is PREVENTION. Keep the alveoli inflating. Do not let them collapse.' (bubble)",
  "'What do you think we do clinically to keep alveoli inflated and prevent atelectasis?' (standalone question)",
  "Guide to: deep breathing, incentive spirometry, positioning, ambulation, positive pressure if needed.",
  "",
  "BREATH SOUNDS CONNECTION, teach this here:",
  "'One more thing before we move on. When the nurse listens to breath sounds and hears decreased sounds in a lobe, what does that actually mean physiologically?' (standalone question)",
  "Guide to: less air is moving in and out of that area. The alveoli in that region are not inflating.",
  "'So decreased breath sounds means alveoli are not inflating in that area. That can be atelectasis.' (bubble)",
  "'We will also see decreased breath sounds in other conditions later, like emphysema, where alveoli are overstretched and destroyed. But atelectasis is a major cause in your clinical patients.' (bubble)",
  "'Say that back: decreased breath sounds means fewer alveoli are inflating in that region.'",
  "",
  ...
  "",
  "STEP 5, WHAT DRIVES BREATHING (2-3 exchanges) — THIS IS MANDATORY AND MUST BE COVERED:",
  "Do NOT skip or abbreviate this step. It is foundational for understanding COPD and Blue Bloater later.",
  ...
  "Affirm the work. Then check which topics from the CONVERSATION TOPIC LIST have been covered.",
  "If obstructive/restrictive and CO2 breathing stimulus have NOT been covered yet: move directly to those steps.",
  "Do NOT offer to wrap up or take a break until STEP 8 (obstructive/restrictive) and STEP 5 (breathing driver) have both been completed.",
  "Only after all key topics are covered: 'Want to keep going with rapid fire, or ready to take a break?'",
  "",
  "STEP 7, RAPID FIRE:",
  ...
  "",
  "STEP 8, OBSTRUCTIVE vs RESTRICTIVE (4-5 exchanges) — THIS IS MANDATORY AND MUST BE COVERED:",
  "Do NOT skip this step under any circumstances. This is the framework for the entire rest of the course.",
  "'Before we wrap up, I want to give you the most important tool in this whole course.' (bubble)",
